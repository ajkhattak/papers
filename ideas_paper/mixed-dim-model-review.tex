...
\newtext{For demonstration purpose, the surface ponded depth and temperature during the snowmelt in 2012 are presented in Fig.~\ref{barrow-pd-temp} for the 468 polygon domain. Fully coupled 3D simulations at such a scale are computationally very expensive.}
...
\caption{Comparison of the subsurface water saturation at locations 1 and 5 during the summer for $\alpha = 1$.}
\label{ss-sat-comp}
\end{figure}
...
\caption{Comparison of subsurface temperature at locations 1 and 5 during the summer for $\alpha = 1$.}
\label{ss-temp-comp}
\end{figure}
...
\caption{An illustration of the surface ponded depths of the two schemes at locations 1 and 5 during the summer for $\alpha = 1$.}
\label{surf-pd-comp}
\end{figure}
...
\caption{An illustration of the speedup study of a simulation with 468 polygons barrow watershed.}
\label{lcs-speed}
\end{figure}
